...
class MedicineAdapter : RecyclerView.Adapter<MedicineAdapter.MainViewHolder>(),
Filterable{

    var medicineFilterList = mutableListOf<MedicineResponse>()
    private var medicineList = mutableListOf<MedicineResponse>()

    fun setMedicineList(medicineResponseList: List<MedicineResponse>) {
        this.medicineList.clear()
        this.medicineList.addAll(medicineResponseList.toMutableList())
